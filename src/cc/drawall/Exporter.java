...
public abstract class Exporter {
	...
	private static final int FLAGS =
		(System.getProperty("reverse") != null ? REVERSE : 0)
		| (System.getProperty("flatten") != null ? FLATTEN : 0)
		| (System.getProperty("optimize") != null ? SHORTEN : 0)
		| (System.getProperty("merge") != null ? MERGE : 0);
