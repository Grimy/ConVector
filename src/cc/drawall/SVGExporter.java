...
public class SVGExporter extends Exporter {
	...
	protected void writeHeader(final Rectangle2D bounds) throws IOException {
		...
		out.writeBytes("<!-- Superbly generated by ConVector -->\n");
		out.writeBytes("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 65535 65535' ");
		writeFormat("width='%f' height='%f'", bounds.getWidth(), bounds.getHeight());
